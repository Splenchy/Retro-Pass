...
La première choses que le joueur entendra sera la son de bienvenu de _Miki_, ce son est réalisé à l'aide de la fonction speaker.tone(), à qui l'on donne la fréquence (en hertz) et la durée (en miliseconde) du son qui sera joué. En complément, nous avons aussi la fonction speaker.setVolume(), pour le volume du son (allant de 0 à 10). Pour décider d'une mélodie, il n'y a qu'à se baser sur un tableau associant les notes de musique (Do,Re, Mi...etc) à leur fréquence : https://i0.wp.com/musicordes.fr/wp-content/uploads/2017/02/tableau-frequences-notes-hertz.png?resize=625%2C301&ssl=1

Vient ensuite les lumières rose qui sont allumées tout le long de la partie. Pour avoir les LEDs allumées de cette couleur nous avions simplement d'une ligne : la ligne 15. Nous disons quelle pin sera utilisé, et à quelle puissance. Ensuite nous utilisons la variable contenant ces paramètre 2 fois : une fois pour les LEDs de gauche, l'autre pour celle de droite. Nous y spécifions ensuite la couleur souhaité (avec les paramètres de couleurs R, G, et B). Le tout est enfin lancé avec la fonction np.write().
...
Le rendu devrait donner à peu près cela : 
                                  ...
                                  <img width="348" height="260" alt="image" src="https://github.com/user-attachments/assets/5beeb4ab-5fdd-439b-85a9-e7874171bd11" />
                                                                                  _Zones text et visage du M5stack_
